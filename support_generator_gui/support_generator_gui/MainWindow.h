...
namespace support_generator {
  ...
  public
    ref class MainWindow : public System::Windows::Forms::Form {
      ...
      private:
        System::Windows::Forms::Button ^ erase_islands_button;
...
#pragma region Windows Form Designer generated code
        ...
        void InitializeComponent(void) {
            ...
            // tabPage1
            //
            this->tabPage1->Controls->Add(this->erase_islands_button);
            ...
            // save_button
            //
            this->save_button->Location = System::Drawing::Point(517, 35);
            ...
            // button2
            //
            this->button2->Location = System::Drawing::Point(517, 64);
            ...
            // numericUpDown1
            //
            this->numericUpDown1->Location = System::Drawing::Point(706, 6);
            ...
            // button1
            //
            this->button1->Location = System::Drawing::Point(832, 6);
            ...
            //
            // erase_islands_button
            //
            this->erase_islands_button->Location =
                System::Drawing::Point(517, 93);
            this->erase_islands_button->Name = L"erase_islands_button";
            this->erase_islands_button->Size = System::Drawing::Size(75, 23);
            this->erase_islands_button->TabIndex = 14;
            this->erase_islands_button->Text = L"erase Islands";
            this->erase_islands_button->UseVisualStyleBackColor = true;
            this->erase_islands_button->Click += gcnew System::EventHandler(
                this, &MainWindow::erase_islands_button_Click);
            //
            // MainWindow
            //
...
#pragma endregion
      ...
      private:
        System::Void button1_Click(System::Object ^ sender,
            ...
            logger_box->AppendText("showing layer " +
                                   this->numericUpDown1->Value);
            System::Drawing::Image ^ image =
                photon_file_adapter::layer_to_image(explicit_layer);
            pictureBox1->Image =
      ...
      private:
        System::Void openFileDialog1_FileOk(
           ...
           /* data_model::file = std::make_unique<photon_file>(
            ...
            logger_box->AppendText(
                "selected open file: " + file_names->GetValue(0) + "\n");
        }
      ...
      private:
        System::Void saveFileDialog1_FileOk(
           ...
           /* data_model::file->write_file(cpp_string);
            logger_box->AppendText(
                "selected save file: " + file_names->GetValue(0) + "\n");*/
        }

      private:
        System::Void erase_islands_button_Click(System::Object ^ sender,
                                                System::EventArgs ^ e) {
            try {
                //data_model::erase_islands();
